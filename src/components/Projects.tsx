...
export default function Projects() {
  ...
  return (
    <div className="bg-white py-24 transition-colors dark:bg-dark-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-12 lg:grid-cols-2 ">
          {projects.map((project) => (
            <div
              key={project.id}
              className="rounded-lg bg-gray-50 overflow-hidden shadow-lg hover:shadow-xl transition-shadow dark:bg-dark-800 dark:shadow-black/30 dark:hover:shadow-black/40"
            >
