    ...
    return (
        <div className="bg-white shadow-md rounded-lg p-6 w-full mx-auto">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">
                Project ID: <span className={"text-gray-400"}> {project.id} </span> (<span
                className={"italic text-gray-500"}>{project.projectStatus}</span>)
            </h2>
            <p className="text-gray-600 mb-6">Created At: {project.createdAt}</p>

            {/* Step 1: Contact Info */}
            <div className="mb-4">
                <button
                    onClick={() => toggleSection("step1")}
                    className="w-full text-left text-lg font-semibold text-gray-700 bg-gray-100 p-3 rounded-md flex justify-between items-center focus:outline-none focus:ring-2 focus:ring-yellow-300"
                >
                    Contact Information
                    <svg
                        ...
                        {project.projectType.toLowerCase() === "designprototyping" ? (
                            <>
                                ...
                                <p>
                                    ...
                                    {project.exampleLink ? (
                                        <a href={project.exampleLink} className="text-blue-500 hover:underline"
